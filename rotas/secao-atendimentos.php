...
<span class="end1">
<!-- 	<p>
		<button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseEnd1" aria-expanded="false" aria-controls="collapseExample">Marcações Por Data</button>
	</p> -->
<!-- 	<div class="collapse" id="collapseEnd1">
	  <div class="card card-body">
	  	<?PHP //require_once('endpoint_atendimentos_marcacoesData.php');?>
	  </div>
	</div> -->
</span>
<span class="end2">
